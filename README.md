...
Discover hidden files through robots.txt.
Access secret web pages.
Analyze source code and hidden clues.
Extract hidden files using steganography.
Obtain credentials.
Gain SSH access.
Escalate privileges.
